...
from cbopensource.connectors.threatconnect.config import Config
...
class TestConfig(TestCase):
    ...
    def test_04a_config_minimal(self):
        ...
        self.assertEqual('/usr/share/cb/integrations/cb-threatconnect-connector/cache', cfg.cache_path)
        self.assertEqual('/carbonblack.png', cfg.cb_image_path)  # fixed
        self.assertFalse(cfg.debug)
        self.assertEqual('ThreatConnect', cfg.display_name)
        self.assertEqual('threatconnectintegration', cfg.feed_name)
